...
insert into orders (org_id, customer, amount, status, paid, created_at, note) values
  ('11111111-1111-1111-1111-111111111111', 'Alice', 100.00, 'paid', true, '2024-01-01T00:00:00Z', 'vip'),
  ('11111111-1111-1111-1111-111111111111', 'Bob', 50.50, 'pending', false, '2024-01-02T00:00:00Z', null),
  ('22222222-2222-2222-2222-222222222222', 'Carol', 999.99, 'paid', true, '2024-01-03T00:00:00Z', 'vip');
